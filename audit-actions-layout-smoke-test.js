...
assert(html.includes('style.css?v=20260922213500'), 'cache do CSS da auditoria não foi atualizado');
assert(html.includes('app.js?v=20260922213500'), 'cache do app da auditoria não foi atualizado');
