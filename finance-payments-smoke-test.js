...
assert(html.includes('app.js?v=20260922211500'), 'cache do app financeiro não foi atualizado');
assert(html.includes('style.css?v=20260922211500'), 'cache do CSS financeiro não foi atualizado');
