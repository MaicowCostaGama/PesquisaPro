...
assert(html.includes('app.js?v=20260923135500'), 'cache do app financeiro não foi atualizado');
assert(html.includes('style.css?v=20260923135500'), 'cache do CSS financeiro não foi atualizado');
