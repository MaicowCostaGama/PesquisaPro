...
assert(html.includes('style.css?v=20260922231400'), 'cache do layout não foi atualizado');
assert(html.includes('app.js?v=20260922231400'), 'cache do app não foi atualizado');
