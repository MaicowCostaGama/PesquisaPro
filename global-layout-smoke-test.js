...
assert(html.includes('style.css?v=20260923135500'), 'cache do layout não foi atualizado');
assert(html.includes('app.js?v=20260923135500'), 'cache do app não foi atualizado');
