...
assert(html.includes('app.js?v=20260922222000'),'cache do app não atualizado');
assert(html.includes('push-config.js?v=20260922222000'),'cache do push não atualizado');
