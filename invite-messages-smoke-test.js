...
assert(html.includes('app.js?v=20260923135500'),'cache do app não atualizado');
assert(html.includes('push-config.js?v=20260923135500'),'cache do push não atualizado');
