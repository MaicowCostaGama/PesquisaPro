...
assert(/pesq:\['dashboard-pesq','researcher-guide','app-collect','researcher-profile','researcher-badge','my-earnings','my-contract','support','communication'\]/.test(app),'Suporte e Comunicação não estão autorizados no menu do pesquisador');
...
assert(/app\.js\?v=20260925092000/.test(html),'Cache do app não foi atualizado');
