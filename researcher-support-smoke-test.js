...
assert(/pesq:\['dashboard-pesq','researcher-guide','app-collect','researcher-badge','my-earnings','my-contract','support'\]/.test(app),'Suporte não está autorizado no menu do pesquisador');
...
assert(/app\.js\?v=20260908250000/.test(html),'Cache do app não foi atualizado');
